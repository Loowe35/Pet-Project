            ...
            <form action="history.php" method="get">
                <div class="input-group">
                    ...
                    <?php if (!empty($search_query)) : ?>
                        <a href="history.php<?= isset($_GET['status']) ? '?status=' . $_GET['status'] : ''; ?>" class="btn btn-secondary">Отмена</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
